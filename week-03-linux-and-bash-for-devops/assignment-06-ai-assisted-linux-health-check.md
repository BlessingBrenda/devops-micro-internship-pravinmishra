...
![alt text](<screenshots/systemctl-active-ass6 (1).png>)
![alt text](screenshots/curl-l-200-OK-ass6.png)
---

#### Screenshot 2 — Output of `pwd` and `find . -maxdepth 4 -type d | sort` showing the workspace folder structure

![alt text](<screenshots/find-maxdepth-ass6 (1).png>)
...
https://github.com/BlessingBrenda/devops-micro-internship-pravinmishra
